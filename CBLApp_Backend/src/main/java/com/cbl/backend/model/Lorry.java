...
import javax.validation.constraints.NotEmpty;
	...
	public class Lorry {
		...
		public String toString() {
			return "Lorry [lorryID=" + lorryID + ", firstName=" + firstName + ", lastName=" + lastName + ", phonenumber=" + phonenumber + ",cashCollector="+ cashCollector + ",lorrystock="+ lorrystock + ",inventoryManager="+ inventoryManager + "]";
		}
